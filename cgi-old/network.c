...
# p_dhcp should be either enabled or disabled\n");
    out_config(NV_P_DHCP,f,nkw,SEP);
    out_config(NV_P_ADDRESS,f,nkw,SEP);
    out_config(NV_P_NETMASK,f,nkw,SEP);
    out_config(NV_P_BROADCAST,f,nkw,SEP);

    fprintf(f,"\n\
# Secondary Interface (RL2/eth0, RL4/wlan0)\
# Ignored at RL3\n");
    out_config(NV_S_DHCP,f,nkw,SEP);
    out_config(NV_S_ADDRESS,f,nkw,SEP);
    out_config(NV_S_NETMASK,f,nkw,SEP);
    out_config(NV_S_BROADCAST,f,nkw,SEP);

    fprintf(f,"\n\
# These should pull from dhcp ...\n");
    out_config(NV_ROUTER,f,nkw,SEP);
    out_config(NV_TFTPHOST,f,nkw,SEP);
    out_config(NV_LOGSVR,f,nkw,SEP);

    fprintf(f,"\n");
    out_config(NV_TIMESVR,f,nkw,SEP);

    fprintf(f,"\n");
    out_config(NV_IW_WATCHDOG_IF,f,nkw,SEP);
    out_config(NV_IW_WATCHDOG_TIME,f,nkw,SEP);

    fprintf(f,"\n\
# Network Swapping\n");
    out_config(NV_SWAPSVR,f,nkw,SEP);
    out_config(NV_SWAPPORT,f,nkw,SEP);
...
# elsewhere\n");
    out_config(NV_MASQ_NET,f,nkw,SEP);
